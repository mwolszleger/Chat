...
--
-- Dumping data for table `offlinemessages`
--

LOCK TABLES `offlinemessages` WRITE;
/*!40000 ALTER TABLE `offlinemessages` DISABLE KEYS */;
INSERT INTO `offlinemessages` VALUES ('sendMsg','zdzisiek','zosiek','czesc');
...
INSERT INTO `users` VALUES ('zdzisiek','haslo');
...
-- Dump completed on 2016-11-16 11:46:57
